...
class Signup(models.Model):
	...
	User_Type = models.CharField(default='NA',max_length=100)	
...
class Anpr_Camera(models.Model):
	Lane_Number = models.IntegerField()
	Created_Time = models.DateTimeField(auto_now_add = True)
	Update_Time = models.DateTimeField(auto_now = True)
	Camera1 =models.GenericIPAddressField(default="NA")
	Camera2 =models.GenericIPAddressField(default="NA")
...
class Relay_Panel(models.Model):
	...
	Relay_Number = models.BooleanField(default=1)
